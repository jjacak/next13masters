...
export type ScheduledOperationAffectedDocument = Asset | Category | Collection | Currency | Order | OrderItem | Product | ProductColorVariant | ProductRating | ProductSizeColorVariant | ProductSizeVariant | Review;
