...
export type CartCreateMutation = { createOrder?: { id: string, total: number } | null };
...
export type CartGetByIdQuery = { order?: { id: string, total: number } | null };

export type CartFragment = { id: string, total: number };
